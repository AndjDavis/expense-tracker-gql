...
import { useUpdateTransaction } from "../hooks/useTransactionMutation";
...
const TransactionPage = () => {
	...
	const { updateTransaction, loading: loadingUpdate } = useUpdateTransaction();
	...
	return (
		<div className="h-screen max-w-4xl mx-auto flex flex-col items-center">
			...
			>
					...
					<div className="w-full flex-1 mb-6 md:mb-0">
						...
						<div className="relative">
							...
							>
								...
								<option value={constants.CATEGORY_INVESTMENT}>
									Investment
								</option>
							</select>
							<div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
				...
				{/* SUBMIT BUTTON */}
				<button
					className="w-full text-white font-bold rounded px-4 py-2 bg-gradient-to-br from-pink-500 to-pink-500 hover:from-pink-600 hover:to-pink-600"
					type="submit"
